...
# Configure hosts based on environment
...
# Pour la production, vous voudrez peut-être restreindre cela:
# CORS_ALLOWED_ORIGINS = [
#     "https://votrefrontend.onrender.com",
#     "http://localhost:3000",
# ]
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.IsAuthenticated',  # Changez de AllowAny à IsAuthenticated
    ],
